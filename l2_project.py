...
class RegressionLearning:
    ...
    def clean_data_with_normalisation(self):
        ...
        log.logger.info("Normalised all continuous columns ")
    ...
    def clean_data_with_standardisation(self):
        ...
        log.logger.info("Standardised all continuous columns ")
...
def main():
    ...
    rl = RegressionLearning(input_data_path="./gr5regression.csv",
                            output_component="Life expectancy",
                            discrete_comp=["Country", "Year", "Status"])
    rl.run()
